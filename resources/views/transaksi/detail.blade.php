...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>{{ $dt ->jumlah }}</td>
        <td>{{ number_format($dt->produk->harga) }}</td>
        ...
        <tr>
                            ...
                            <tr>
                                <td colspan="5" align="left"><strong>Kode Unik : {{ number_format($transaksi->kode) }}</strong></td>
                                

                            </tr>
                             <tr>
                                <td colspan="5" align="left"><strong>Total yang harus ditransfer : {{ number_format($transaksi->kode+$transaksi->total) }}</strong></td>
